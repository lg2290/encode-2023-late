...
export default function CreateChallenge(props:any) {
                ...
                <div>
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                         Create a price prediction challenge.
                        </p>
                    </div>
                  </div>
                  <div className="mt-4 ">
                  ...
                  <label
                        ...
                        <input
                          ...
                          className="w-full text-white rounded-md border border-stroke bg-[#353444] py-3 px-6 text-base font-medium text-body-color outline-none transition-all focus:bg-[#454457] focus:shadow-input"
                        />
                        

                        <label
                          for="greaterThanOrLessThan"
                          className="mt-2 mb-2 block text-base font-medium"
                        >
                          Comparison
                        </label>
                        <select
                          name="greaterThanOrLessThan"
                          id="greaterThanOrLessThan"
                          required
                          className="w-full rounded-md border border-stroke bg-[#353444] py-3 px-6 text-white text-base font-medium  outline-none transition-all focus:bg-[#454457] focus:shadow-input"
                        >
